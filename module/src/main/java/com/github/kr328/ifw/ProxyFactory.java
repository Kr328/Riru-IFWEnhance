...
public class ProxyFactory {
    public static Binder instance(IBinder original, Binder replaced) throws ReflectiveOperationException {
        ...
        if (impl == null)
            throw new NoSuchMethodException(replaced.toString() + ".asInterface return null");
        ...
        for (Method method : replaced.getClass().getMethods()) {
            ...
            try {
                ...
                Log.w(Injector.TAG, "hook " + original.getClass().toGenericString() + " failure", e);
            }
        }

        Log.i(Injector.TAG, "hook " + codes.toString());
